...
cl.5.2.ward.with.missing=cutree(bu.hc,k=6)
###########################################
...
#############################################
# make list of clusters suitable for map
cl.5.2.ward.no.missing=cutree(bu.hc,k=6)
############################################
...
###################################
# kmeans
cl.5.2.kmeans.no.missing=bu.km6$cluster
####################################
