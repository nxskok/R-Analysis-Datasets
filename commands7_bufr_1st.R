# rows 1 to 20 (Years 1971 to 1990)
...
# rbind
hbdata9=rbind(hbdata5[1:20,],hbdata7[1:20,])
...
cl.7.1.ward.with.missing=cutree(bu.hc,k=6)
###########################################
...
#############################################
# make list of clusters suitable for map
cl.7.1.ward.no.missing=cutree(bu.hc,k=6)
############################################
...
###################################
# kmeans
cl.7.1.kmeans.no.missing=bu.km6$cluster
####################################
