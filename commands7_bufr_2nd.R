...
# rbind
hbdata9=rbind(hbdata5[21:41,],hbdata7[21:41,])
hbdata9
# check for missings
...
cl.7.2.ward.with.missing=cutree(bu.hc,k=6)
###########################################
...
#############################################
# make list of clusters suitable for map
cl.7.2.ward.no.missing=cutree(bu.hc,k=6)
############################################
...
###################################
# kmeans
cl.7.2.kmeans.no.missing=bu.km6$cluster
####################################
